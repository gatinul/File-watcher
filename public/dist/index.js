...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.folder = exports.app = undefined;
	...
	var _jstree = __webpack_require__(29);
	
	var _fileWatcher = __webpack_require__(30);
	...
	$(function () {
		new _fileWatcher2.default();
		$("#treeView").jstree({
			'core': {
				"multiple": false,
				'data': _jstree.ay_mssys,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fileWatcher = function (_base) {
	  _inherits(fileWatcher, _base);
	
	  function fileWatcher(options) {
	    _classCallCheck(this, fileWatcher);
	
	    var _this = _possibleConstructorReturn(this, (fileWatcher.__proto__ || Object.getPrototypeOf(fileWatcher)).call(this, options));
	
	    _get(fileWatcher.prototype.__proto__ || Object.getPrototypeOf(fileWatcher.prototype), 'bindEvent', _this).call(_this);
	    return _this;
	  }
	  ...
	  _createClass(fileWatcher, [{
	    ...
	    value: function refresh() {
	      _axios2.default.get('/refresh').then(function (response) {
	        var data = response.data;
	        if (data) {
	          _index.app.show = true;
	        }
	        var arr = data.split('-');
	        var items = [];
	        for (var i = 0; i < arr.length; i++) {
	    ...
	    value: function sure() {
	      ...
	      _axios2.default.post('/sure', {
	        "folder": _index.folder[0]
	      }).then(function (response) {});
	    }
	  }, {
	    key: 'unbindEvent',
	    value: function unbindEvent() {
	      _get(fileWatcher.prototype.__proto__ || Object.getPrototypeOf(fileWatcher.prototype), 'unbindEvent', this).call(this);
	    }
	  }, {
	    key: 'destroy',
	    value: function destroy() {
	      _get(fileWatcher.prototype.__proto__ || Object.getPrototypeOf(fileWatcher.prototype), 'destroy', this).call(this);
	      this.unbindEvent(this.eventsMap);
	    }
	  }]);
	
	  return fileWatcher;
	}((0, _base3.default)(_config2.default));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var base = function base(supperclass) {
	    return function (_supperclass) {
	        ...
	        _createClass(_class, [{
	            ...
	            value: function _delegate(name, selector, func) {
	                (0, _jQuery2.default)(document).on(name, selector, func);
	            }
	        }, {
	            key: '_undelegate',
	            value: function _undelegate(name, selector, func) {
	                (0, _jQuery2.default)(document).off(name, selector, func);
	            }
	        }, {
